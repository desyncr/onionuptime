  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved status as @status" do
        ...
        post :create, {:status => { "onion" => "invalid value" }}, valid_session
        assigns(:status).should be_a_new(Status)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested status" do
        ...
        Status.any_instance.should_receive(:update).with({ "onion" => "1" })
        put :update, {:id => status.to_param, :status => { "onion" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the status as @status" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Status.any_instance.stub(:save).and_return(false)
        put :update, {:id => status.to_param, :status => { "onion" => "invalid value" }}, valid_session
        assigns(:status).should eq(status)
      end
